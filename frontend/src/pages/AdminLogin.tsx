  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        ...
        <main className="container max-w-6xl py-8 sm:py-12 px-4 relative z-10">
          <div className="grid lg:grid-cols-5 gap-6 sm:gap-8 items-start">
            <section className="lg:col-span-2 text-white animate-fade-in">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold mb-3">Admin Portal</h1>
              <p className="text-sm sm:text-base text-gray-300 max-w-md">
                Secure access to routes, payments, vehicles, occupancy, reports, and operational oversight.
              </p>

              <div className="mt-6 space-y-3">
                <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                  <p className="text-sm font-semibold text-white mb-1">Operational control</p>
                  <p className="text-xs text-gray-300">Manage transport intelligence from one dashboard.</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                  <p className="text-sm font-semibold text-white mb-1">Protected session handling</p>
                  <p className="text-xs text-gray-300">Concurrent access is restricted to reduce account misuse.</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                  <p className="text-sm font-semibold text-white mb-1">Demo-ready access</p>
                  <p className="text-xs text-gray-300">Use the provided demo account when presenting the platform.</p>
                </div>
              </div>
            </section>

            <section className="lg:col-span-3 bg-white/5 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-white/10 shadow-2xl">
              {sessionInvalidated && (
